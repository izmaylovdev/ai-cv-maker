  ...
  template: `
    <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl p-6 w-[calc(100vw-2rem)] max-w-[480px] flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-1">
        <label for="cv-notes" class="text-sm font-medium text-gray-700 dark:text-zinc-300">
          Optimization notes
          <span class="font-normal text-gray-400 dark:text-zinc-500">(optional)</span>
        </label>
        <textarea id="cv-notes" rows="4" [(ngModel)]="notes"
          ...
          class="w-full border border-gray-300 dark:border-zinc-600 rounded-lg px-3 py-2 text-sm bg-white dark:bg-zinc-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-y">
        </textarea>
      </div>
